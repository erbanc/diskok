...
One ball, one target. **Tap once to lock the angle, tap again to lock the
power**, then watch the ball arc, bounce, and (hopefully) kiss the pad. Miss and
the level restarts instantly. Pastel, geometric, fluid — inspired by the clean
minimalism of Philipp Stollenmayer's games.
